...
## Reflection
Reflecting on my academic and industrial timeline at Universiti Teknologi Malaysia (UTM) highlights a major structural transformation in my approach to engineering data. My journey began in **Year 1 with Programming Technique 1 and 2**, where I developed a deep respect for procedural logic, deterministic memory states, and object encapsulation boundaries in C++. Building the core engine of the *Equinox Banking System* taught me that data integrity must be protected at the code layer through strict access rules, data isolation, and clean logic structures long before it ever reaches a persistent database layer.

As I progressed into **Year 3**, my understanding expanded from managing local data arrays to architecting distributed enterprise systems. My field engagements with **PPG Industries, iZeno, and Telekom Malaysia (TM)** bridged the gap between academic theory and high-velocity corporate production. The local validation checks I once wrote in C++ evolved into scalable cloud ingestion functions deployed inside **Microsoft Azure** for the *Recoverable Assets Pipeline*. Similarly, the multi-object structures I built in class became containerized microservices managed via **Docker Desktop** and orchestrators to achieve horizontal elasticity.
